...
<div id="main" class="container">
    <div class="wrapper row">
        <div id="book-appointment-wizard" class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
            ...
            <div id="header">
                <span
                    id="company-name"><?= lang('hello') . " " . $this->session->userdata['social_login_instagram_info']['full_name'] . "!" ?></span>
                    ...
                    <div class="col-xs-12 col-sm-2">
                        <form id="cancel-appointment-form" method="post"
                            ...
                            <button id="cancel-appointment"
                                    class="btn btn-default btn-sm"><?= lang('cancel') ?></button>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="first-name" class="required form-control" maxlength="100"
                                       value="<?= $this->session->userdata['social_login_instagram_info']['full_name'] ?>"/>
                            </div>
                            <div class="form-group">
